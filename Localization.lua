...
Strings.L = setmetatable({}, { __index = function(t, k) return k; end });
local L = Strings.L


local function color(hexARGB, text) return "|c"..hexARGB..text.."|r" end
local function green(text) return color("FF00A800", text) end	-- like the "You receive item: [whatever]" messages
local function white(text) return color("FFFFFFFF", text) end
local function red(text) return color("FFA00000", text) end
...
Strings.STACK_SIZE_PATTERN		= "%(([0-9]+)%)$" -- NEVER NEEDS LOCALIZATION
...
elseif (LOCALE == "deDE") then
	...
	L[Strings.FMT_CANCELLED_ITEM] = "Ihr erhaltet den Gegenstand: %sx%d. Auktion Abgebrochen."
	
	L[Strings.FMT_RECEIVE_MONEY] = "Sie erhalten %s"
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "Sie erhalten %s für %sx%d"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "Sie erhalten %s für %sx%d (je 0,99)"
...
elseif (LOCALE == "esES" or LOCALE == "esMX") then
	...
	L[Strings.FMT_PURCHASED_SINGLE] = "Usted compró el artículo %sx%d por %s"
	...
	L[Strings.FMT_CANCELLED_ITEM] = "Recibes: %sx%d. Cancelado subasta."
	
	L[Strings.FMT_RECEIVE_MONEY] = "Recibes %s"
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "Recibes %s por %sx%d"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "Recibes %s por %sx%d (%s cada uno)"
...
elseif (LOCALE == "frFR") then
	...
	L[Strings.FMT_PURCHASED_SINGLE] = "Vous avez acheté %sx%d à %s"
	...
	L[Strings.FMT_CANCELLED_ITEM] = "Vous recevez l'objet : %sx%d. Vente aux enchères annulée."
	
	L[Strings.FMT_RECEIVE_MONEY] = "Vous recevez %s"
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "Vous recevez %s pour %sx%d"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "Vous recevez %s pour %sx%d (0,99 chacun)"
...
elseif (LOCALE == "itIT") then
	...
	L[Strings.FMT_PURCHASED_SINGLE] = "Hai comprato %sx%d per %s"
	L[Strings.FMT_PURCHASED_MULTIPLE] = "Hai comprato %s per %s ciascuno"
	L[Strings.FMT_EXPIRED_ITEM] = "Hai ricevuto: %s. scaduto Asta."
	L[Strings.FMT_CANCELLED_ITEM] = "Hai ricevuto: %sx%d. Asta Annullato."
	
	L[Strings.FMT_RECEIVE_MONEY] = "Ricevi %s"
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "Ricevi %s per %sx%d"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "Ricevi %s per %sx%d (0,99 ciascuno)"
...
elseif (LOCALE == "koKR") then
	...
	L[Strings.FMT_PURCHASED_SINGLE] = "나는 %sx%d를 사서 %s를 보냈다"
	L[Strings.FMT_PURCHASED_MULTIPLE] = "당신은 %s를 구입하고 각각 %s를 보냈습니다"
	L[Strings.FMT_EXPIRED_ITEM] = "아이템을 획득했습니다: %s 경매 만료."
	L[Strings.FMT_CANCELLED_ITEM] = "아이템을 획득했습니다: %sx%d 경매 취소."
	
	L[Strings.FMT_RECEIVE_MONEY] = "%s받습니다."
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "%s을 받음 : %sx%d를 판매 함"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "%s을 받음 : %sx%d를 판매 함 (각 %s)"
...
elseif (LOCALE == "ptBR") then
	...
	L[Strings.FMT_PURCHASED_SINGLE] = "Você comprou a %sx%d por %s"
	...
	L[Strings.FMT_CANCELLED_ITEM] = "Você recebe o item: %sx%d. leilão cancelado."
	
	L[Strings.FMT_RECEIVE_MONEY] = "Você recebe %s"
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "Você recebe %s para %sx%d"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "Você recebe %s para %sx%d (0,99 cada)"
...
elseif (LOCALE == "ruRU") then
	...
	L[Strings.FMT_PURCHASED_SINGLE] = "Вы купили %sx%d за %s"
	...
	L[Strings.FMT_CANCELLED_ITEM] = "Вы получаете предмет: %sx%d. Аукцион Отменено."
	
	L[Strings.FMT_RECEIVE_MONEY] = "Вы получаете %s"
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "Вы получаете %s за %sx%d"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "Вы получаете %s за %sx%d (0,99 каждый)"
...
elseif (LOCALE == "zhCN") then
	...
	L[Strings.FMT_PURCHASED_SINGLE] = "你买了%sx%d并花了%s"
	L[Strings.FMT_PURCHASED_MULTIPLE] = "你买了%s每个%s"
	L[Strings.FMT_EXPIRED_ITEM] = "你获得了物品：%s。 拍卖过期."
	L[Strings.FMT_CANCELLED_ITEM] = "你获得了：%sx%d。 拍卖取消."
	
	L[Strings.FMT_RECEIVE_MONEY] = "您收到%s"
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "您收到%s：已售出%sx%d"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "您收到%s：已售出%sx%d（每个%s）"
...
elseif (LOCALE == "zhTW") then
	...
	L[Strings.FMT_PURCHASED_SINGLE] = "你買了%sx%d並花了%s"
	L[Strings.FMT_PURCHASED_MULTIPLE] = "你買了%s每個%s"
	L[Strings.FMT_EXPIRED_ITEM] = "你獲得了物品:%s。 拍賣過期."
	L[Strings.FMT_CANCELLED_ITEM] = "你獲得物品:%sx%d。 拍賣取消."
	
	L[Strings.FMT_RECEIVE_MONEY] = "您收到%s"
	L[Strings.FMT_RECEIVE_MONEY_SINGLE_ITEM] = "您收到%s：已售出%sx%d"
	L[Strings.FMT_RECEIVE_MONEY_MULTI_ITEM] = "您收到%s：已售出%sx%d（每個%s）"
